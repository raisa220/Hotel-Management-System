...
select * from room;
select * from driver;
delete from driver where age = 29;
create table employees(n varchar(25), age varchar(10), gender varchar(15), job varchar(30), salary varchar(15), phone varchar(15), email varchar(40), nid varchar(20));
